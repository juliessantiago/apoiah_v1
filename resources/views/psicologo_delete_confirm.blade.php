...
<head>
    ...
    <title>Psicologo Selecionado</title>
</head>
<body class="p-4 m-4">
    @if ($psicologo)
    
    <form action="{{route('destroy_psicologo', $psicologo->id)}}" method="POST" class="col-md-6 offset-md-3">
    <p>Você tem certeza de que deseja excluir: </p>
    <h3 class="text-secondary">Psicólogo nº {{$psicologo->id}} - {{ $psicologo->nome }}?</h3>
